        ...
        "events": {
            ...
            "items": {
                ...
                "properties": {
                    "event_type": {
                        "type": "string",
                        "enum": ["error", "warning", "milestone", "decision_point"],
                    },
                    "run_id": {"type": "string"},
        ...
        "evidence": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "type": {
                        "type": "string",
                        "enum": ["input", "output", "error", "decision", "context"],
                    },
                    "run_id": {"type": "string"},
        ...
        "gaps": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "status": {
                        "type": "string",
                        "enum": ["met", "partial", "missing", "incorrect"],
                    },
                    "severity": {
                        "type": "string",
                        "enum": ["critical", "high", "medium", "low"],
        ...
        "remediations": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "effort_estimate": {
                        "type": "string",
                        "enum": ["trivial", "small", "medium", "large", "extensive"],
                    },
